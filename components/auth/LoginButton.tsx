...
export default function LoginButton() {
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className="flex items-center gap-2 rounded-lg bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-md transition-all hover:bg-gray-50 hover:shadow-lg disabled:cursor-not-allowed disabled:opacity-50"
    >
      {isLoading ? (
        <>
